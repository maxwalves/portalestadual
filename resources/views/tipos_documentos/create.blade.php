...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Cadastrar Novo Tipo de Documento</h3>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('descricao') is-invalid @enderror" 
                              ...
                              name="descricao" 
                              rows="3" 
                              placeholder="Descrição detalhada do tipo de documento">{{ old('descricao') }}</textarea>
                    @error('descricao')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('extensoes_permitidas') }}" 
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('tamanho_maximo_mb', 10) }}" 
                                   min="1" 
                                   max="1024"
                                   required>
