                ...
                <div class="card card-warning">
                    <div class="card-header">
                        <h3 class="card-title">
                            ...
                            Editar Ação: {{ $acao->descricao }}
                        </h3>
                    </div>
                    <form action="{{ route('acoes.update', $acao) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            @if($errors->any())
                                        ...
                                        <select class="form-control select2 @error('demanda_id') is-invalid @enderror" 
                                            ...
                                            @foreach($demandas as $demanda)
                                                <option value="{{ $demanda->id }}" 
                                                        {{ old('demanda_id', $acao->demanda_id) == $demanda->id ? 'selected' : '' }}>
                                                    {{ $demanda->descricao }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               id="projeto_sam" 
                                               name="projeto_sam" 
                                               value="{{ old('projeto_sam', $acao->projeto_sam) }}" 
                                        ...
                                        <select class="form-control select2 @error('tipo_fluxo_id') is-invalid @enderror" 
                                            ...
                                            @foreach($tipoFluxos as $tipoFluxo)
                                                <option value="{{ $tipoFluxo->id }}" 
                                                        {{ old('tipo_fluxo_id', $acao->tipo_fluxo_id) == $tipoFluxo->id ? 'selected' : '' }}>
                                                    {{ $tipoFluxo->nome }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   id="valor_estimado" 
                                                   name="valor_estimado" 
                                                   value="{{ old('valor_estimado', $acao->valor_estimado ? number_format($acao->valor_estimado, 2, ',', '.') : '') }}" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   value="{{ old('valor_contratado', $acao->valor_contratado ? number_format($acao->valor_contratado, 2, ',', '.') : '') }}" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" 
                                                   ...
                                                   id="localizacao" 
                                                   name="localizacao" 
                                                   value="{{ old('localizacao', $acao->localizacao) }}" 
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    <a href="{{ route('acoes.show', $acao) }}" class="btn btn-info">
