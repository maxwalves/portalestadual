                ...
                <div class="card card-warning card-outline">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <span class="badge badge-warning">ID: {{ $demanda->id }}</span>
                        </div>
                    </div>
                    <form action="{{ route('demandas.update', $demanda) }}" method="POST" id="demanda-form">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('prioridade_sam', $demanda->prioridade_sam) }}" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="termo_adesao_id" 
                                            ...
                                            @foreach($termosAdesao as $termo)
                                                <option value="{{ $termo->id }}" {{ old('termo_adesao_id', $demanda->termo_adesao_id) == $termo->id ? 'selected' : '' }}>
                                                    {{ $termo->descricao }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="cadastro_demanda_gms_id" 
                                            ...
                                            @foreach($cadastrosDemandaGms as $cadastro)
                                                <option value="{{ $cadastro->id }}" {{ old('cadastro_demanda_gms_id', $demanda->cadastro_demanda_gms_id) == $cadastro->id ? 'selected' : '' }}>
                                                    {{ $cadastro->descricao }}
                                ...
                                <div class="col-md-12">
                                    <div class="alert alert-info">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <small>
                                                    <strong>Criado em:</strong> {{ $demanda->created_at->format('d/m/Y H:i:s') }}
                                                </small>
                                            </div>
                                            <div class="col-md-6">
                                                <small>
                                                    <strong>Última atualização:</strong> {{ $demanda->updated_at->format('d/m/Y H:i:s') }}
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <a href="{{ route('demandas.show', $demanda) }}" class="btn btn-info btn-block">
