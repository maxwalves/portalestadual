...
<body
    class="bg-[#FDFDFC] text-[#1b1b18] flex p-4 md:p-6 lg:p-8 items-center justify-center min-h-screen">
    <div class="flex flex-col items-center justify-center w-full gap-4 md:gap-6 lg:gap-8 max-w-7xl mx-auto">
        <!-- Bloco Principal -->
        <main
            class="bg-white shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] rounded-lg w-full overflow-hidden">
            <div class="flex flex-col lg:flex-row">
                <!-- Logo em telas pequenas -->
                <div
                    class="lg:hidden w-full bg-white p-6 flex justify-center border-b border-[#19140035]">
                ...
                <div class="flex-1 p-6 md:p-8 lg:p-20">
                    <h1 class="text-xl md:text-2xl lg:text-3xl font-semibold mb-3 md:mb-4">
                        Portal de Obras Estaduais</h1>
                    <h2 class="text-lg md:text-xl font-medium mb-2">Paranacidade</h2>

                    <p class="text-sm md:text-base text-[#706f6c] font-normal">
                ...
                <div
                    class="hidden lg:flex lg:w-[438px] shrink-0 items-center justify-center p-8 lg:border-l border-[#19140035]">
                    <img src="{{ asset('images/loginPortalObrasEstaduais.png') }}" alt="Logo Paranacidade"
        ...
        @guest
            <div
                class="bg-white shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] rounded-lg w-full lg:max-w-[400px] p-6 md:p-8">
                <h3 class="text-lg md:text-xl font-semibold mb-4 text-center">Acesso ao Sistema</h3>
                ...
                @if (session('status'))
                    ...
                    @endphp
                    <div
                        class="mb-4 p-4 rounded-md {{ $isSuccess ? 'bg-green-50 border-green-200 text-green-800' : 'bg-red-50 border-red-200 text-red-800' }} border">
                        <div class="flex">
                            <div class="flex-shrink-0">
                                <svg class="h-5 w-5 {{ $isSuccess ? 'text-green-400' : 'text-red-400' }}"
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4">
                    ...
                    <div class="flex items-center justify-center mb-4">
                        <div class="inline-flex rounded-md shadow-sm" role="group">
                            <button type="button" id="user_type_ldap"
                                class="px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-gray-200 rounded-l-lg hover:bg-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-white transition-colors duration-200">
                                Paranacidade
                            </button>
                            <button type="button" id="user_type_externo"
                                class="px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-r-lg hover:bg-gray-50 hover:text-gray-900 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 transition-colors duration-200">
                                Usuário Externo
                            </button>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" name="email" id="email" required
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm md:text-base font-normal @error('email') border-red-300 @enderror"
                                value="{{ old('email') }}">
                            <div id="email_domain"
                                class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none text-gray-500 text-sm md:text-base">
                                @paranacidade.org.br
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="password" name="password" id="password" required
                            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm md:text-base font-normal @error('password') border-red-300 @enderror">
                    </div>
                    ...
                    <button type="submit"
                        class="w-full flex justify-center py-2.5 md:py-3 px-4 border border-transparent rounded-md shadow-sm text-sm md:text-base font-semibold text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        Entrar
                    </button>
                </form>
            </div>
